"""Perceba que temos uma coleção de valores e operações que
atuam sobre estes valores, de acordo com o que foi definido pelo TAD."""
import sys
...
class Array:
    ...
    def __len__(self):
        # quando pedido o tamanho do array, retorne o tamanho de data
...
print("tamanho da lista em bytes 1:", array_memory_size)
...
array_memory_size = sys.getsizeof(array.data)
print("tamanho da lista em bytes 2:", array_memory_size)
...
array_memory_size = sys.getsizeof(array.data)
print("tamanho da lista em bytes 3:", array_memory_size)
...
array_memory_size = sys.getsizeof(array.data)
print("tamanho da lista em bytes 4:", array_memory_size)
