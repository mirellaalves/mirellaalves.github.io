...
# split para pegar cada valor separado. O método isdigit, embutido no
# tipo str, pode ser utilizado para verificar se a string corresponde
# a um número natural.

numbers = input("Digite os números separados por um espaço: ")
...
print("A soma dos valores válidos é: ", sum_numbers)
